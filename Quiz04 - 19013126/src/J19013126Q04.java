abstract class Printer {
    ...
    public Printer(String modelName, String manufacturer, int type)
    {
...
class InkjetPrinter extends Printer {
    ...
    public InkjetPrinter(String modelName, String manufacturer, int type, int numberOfPaper, int amountOfInk) {
        super(modelName, manufacturer, type);
        setNumberOfPaper(numberOfPaper);
        setNumberOfPrinted(0);
